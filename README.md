...
| kind                  | identifier(s)                                                                                          |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| natmod (`.mpy`)       | `mpy6.3-v1.28.0-{x86,x64,armv6m,armv7m,armv7emsp,armv7emdp,xtensa,xtensawin,rv32imc,rv64imc}`            |
| usermod, unix          | `v1.28.0-manylinux_2_28_{x86_64,i686,aarch64}`, `v1.28.0-manylinux_2_31_armv7l`                          |
| usermod, windows       | `v1.28.0-{win32,win_amd64,win_arm64}`                                                                    |
| usermod, webassembly   | `v1.28.0-wasm32`                                                                                         |
| usermod, esp32         | `v1.28.0-esp32-ESP32_GENERIC`                                                                            |
| usermod, rp2           | `v1.28.0-rp2-{RPI_PICO,RPI_PICO2,RPI_PICO2_W}`                                                           |

A glob also works, e.g. `cibuildmp --build "mpy6.3-v1.28.0-*"` for every
